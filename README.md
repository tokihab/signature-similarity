...
* **Web App:** [Streamlit Live App](https://siamese-signature-similarity.streamlit.app/)
* **Dataset:** [Sig-DS Dataset on Hugging Face](https://huggingface.co/datasets/T0KII/signatures-dataset)
* **Model Repository:** [Siamese Model on Hugging Face](https://huggingface.co/T0KII/signature-similarity)
